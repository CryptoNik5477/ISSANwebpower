...
const STRINGS: Record<string, { heading: string; body: string; date: string; id: string; signed: string }> = {
  en: {
    ...
    date: "Date of issue",
    id: "Certificate ID",
    signed: "Director of Studies, Thai Rocket School",
  },
  fr: {
    ...
    signed: "Directeur des études, Thai Rocket School",
  },
  de: {
    ...
    id: "Zertifikats-ID",
    signed: "Studienleitung, Thai Rocket School",
  },
};
...
export async function generateCertificatePdf(data: CertificateData): Promise<Uint8Array> {
  ...
  center("Thai Rocket School", serif, 26, height - 100, gold);
