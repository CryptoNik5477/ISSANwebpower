    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 pb-24 pt-32 sm:px-6">
        ...
        <div className="prose prose-invert mt-8 space-y-4 text-sm leading-relaxed text-night-300">
          <p>
            Thai Rocket School is committed to protecting your personal data in accordance with the GDPR. We collect only the
          ...
          <p>
            ...
            <a href="mailto:privacy@thairocketschool.com" className="text-gold-400">privacy@thairocketschool.com</a>. Transactional
